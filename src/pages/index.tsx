  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Discover Restaurant Booking Engine - Streamlining your dining experience by enabling table reservations and empowering restaurant staff to manage reservations and menus efficiently."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Discover Restaurant Booking Engine - Streamlining your dining experience by enabling table reservations and empowering restaurant staff to manage reservations and menus efficiently.`}
            </Text>
            <Box
